...
const Home = () => {
    ...
    return (
        <>
            <head>
                <title>Elden Ring Message Generator - Create Messages Easily</title>
                <meta name="description" content="Generate custom messages for Elden Ring. Easy-to-use tool for creating messages with filtering options." />
