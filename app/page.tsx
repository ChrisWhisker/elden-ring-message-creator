  ...
  return (
    <main className="flex flex-col min-h-screen items-center p-4 lg:p-8 xl:p-12">
      <div className="absolute top-4 right-4 flex space-x-2">
        ...
        <a href="https://www.linkedin.com/in/chrisworcester/" target="_blank" rel="noopener noreferrer" className="mx-2">
      ...
      <div id="Filter input" className="z-10 w-full max-w-5xl flex items-center justify-center body-text text-sm lg:text-base">
        <input id="inputBox" ref={inputRef} type="text" className="inputBox w-full lg:w-96 px-4 py-2 rounded border border-gray-400 focus:border-yellow-400 focus:outline-none" value={searchText} onChange={handleInputChange} placeholder="Filter words" />
      </div>
